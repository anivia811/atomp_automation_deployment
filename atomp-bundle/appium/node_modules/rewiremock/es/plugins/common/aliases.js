...
function getConfigPath(configPaths) {
  ...
  try {
    for (var _iterator = configPaths[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var configPath = _step.value;

      if (!configPath) continue;

      var resolvedConfigPath = resolve(process.cwd(), configPath);

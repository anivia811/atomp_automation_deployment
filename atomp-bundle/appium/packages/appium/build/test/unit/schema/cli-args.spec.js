...
const cli_args_1 = require("../../../lib/schema/cli-args");
const { expect } = chai_1.default;
chai_1.default.use(chai_as_promised_1.default);
describe('cli-args', function () {
    async function getArgs(opts = {}) {
        ...
        return Object.fromEntries([...(0, cli_args_1.toParserArgs)()]);
    }
    beforeEach(schema_1.resetSchema);
    afterEach(schema_1.resetSchema);
    describe('toParserArgs()', function () {
        describe('schema contents', function () {
            const extName = 'blob';
            const extType = constants_1.PLUGIN_TYPE;
            ...
            describe('enum', function () {
                describe('when used with a non-`string` type', function () {
                    it('should throw', async function () {
                        ...
                        await expect(getArgs({ schema, extName, extType })).to.be.rejectedWith(TypeError, /`enum` is only supported for `type: 'string'`/i);
                    });
                });
...
//# sourceMappingURL=cli-args.spec.js.map
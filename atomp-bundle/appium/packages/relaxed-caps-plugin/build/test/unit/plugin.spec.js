...
describe('relaxed caps plugin', function () {
    ...
    const rcp = new plugin_1.RelaxedCapsPlugin('relaxed-caps');
    it('should export the name', function () {
        (0, chai_1.expect)(plugin_1.RelaxedCapsPlugin).to.exist;
    });
    describe('#fixCapsIfW3C', function () {
        ...
        it('should not transform standard caps', function () {
            (0, chai_1.expect)(rcp['fixCapsIfW3C']({ alwaysMatch: STD_CAPS })).to.eql({ alwaysMatch: STD_CAPS });
        });
        it('should transform non-standard caps', function () {
            (0, chai_1.expect)(rcp['fixCapsIfW3C']({ alwaysMatch: MIXED_CAPS })).to.eql({ alwaysMatch: ADJUSTED_CAPS });
        });
        it('should not transform already prefixed caps', function () {
            (0, chai_1.expect)(rcp['fixCapsIfW3C']({ firstMatch: [VENDOR_CAPS], alwaysMatch: VENDOR_CAPS })).to.eql({
                firstMatch: [ADJUSTED_VENDOR_CAPS],
                alwaysMatch: ADJUSTED_VENDOR_CAPS,
            });
        });
        it('should not transform non-W3C caps', function () {
            (0, chai_1.expect)(rcp['fixCapsIfW3C']({ desiredCapabilities: VENDOR_CAPS })).to.eql({

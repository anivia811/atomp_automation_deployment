...
describe('Strongbox', function () {
    ...
    let MockFs = {};
    let expect;
    const DATA_DIR = node_path_1.default.resolve('some', 'dir', 'strongbox');
    ...
    beforeEach(function () {
        ...
        ({ strongbox, DEFAULT_SUFFIX, Strongbox } = node_1.default.proxy(() => require('../../lib'), (r) => ({
        ...
        describe('create()', function () {
            ...
            describe('when provided an absolute container path', function () {
                it('should use the provided container path', function () {
                    const container = node_path_1.default.resolve(node_path_1.default.sep, 'somewhere');
            ...
            describe('when provided a relative container path', function () {
                it('should throw an error', function () {
                    const container = node_path_1.default.join('somewhere', 'else');
                    expect(() => strongbox('test', { container })).to.throw(TypeError, `container slug ${container} must be an absolute path`);
                });
            });
    ...
    describe('instance method', function () {
        ...
        describe('createItem()', function () {
            describe('when a Item with the same id does not exist', function () {
                describe('when the file does not exist', function () {
                    ...
                    it('should create an empty Item', async function () {
                        expect(item).to.eql({
                            id: node_path_1.default.resolve(DATA_DIR, 'strongbox', 'SLUG-test'),
                            name: 'SLUG test',
                            encoding: 'utf8',
                            value: undefined,
                            container: node_path_1.default.resolve(DATA_DIR, 'strongbox'),
                        });
                    });
                });
                ...
                describe('when a value is written to the Item', function () {
                    it('should write a string value to the underlying file', async function () {
                        ...
                        expect(MockFs.writeFile.calledWith(node_path_1.default.resolve(DATA_DIR, DEFAULT_SUFFIX, 'test'), 'boo bah', 'utf8')).to.be.true;
                    });
            ...
            describe('when a Item with the same id already exists', function () {
                it('should throw an error', async function () {
                    ...
                    await expect(box.createItem('test')).to.be.rejectedWith(Error, `Item with id "${node_path_1.default.resolve(DATA_DIR, 'strongbox', 'test')}" already exists`);
                });
            });
        ...
        describe('createItemWithValue()', function () {
            ...
            it('should write the value to disk', async function () {
                ...
                expect(MockFs.writeFile.calledWith(node_path_1.default.resolve(DATA_DIR, DEFAULT_SUFFIX, 'test'), 'value'))
                    .to.be.true;
            });
...
//# sourceMappingURL=strongbox.spec.js.map